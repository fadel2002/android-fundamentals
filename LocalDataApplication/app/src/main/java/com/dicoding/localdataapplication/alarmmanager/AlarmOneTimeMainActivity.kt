package com.dicoding.localdataapplication.alarmmanager
...
import com.dicoding.localdataapplication.databinding.ActivityAlarmOneTimeMainBinding
import java.util.*

class AlarmOneTimeMainActivity : AppCompatActivity(), View.OnClickListener, DatePickerFragment.DialogDateListener, TimePickerFragment.DialogTimeListener {

    private var binding: ActivityAlarmOneTimeMainBinding? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityAlarmOneTimeMainBinding.inflate(layoutInflater)
