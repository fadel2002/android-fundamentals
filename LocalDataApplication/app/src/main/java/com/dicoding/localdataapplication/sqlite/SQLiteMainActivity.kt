package com.dicoding.localdataapplication.sqlite
...
import com.dicoding.localdataapplication.databinding.ActivitySqliteMainBinding
import com.dicoding.localdataapplication.sqlite.adapter.NoteAdapter
import com.dicoding.localdataapplication.sqlite.db.NoteHelper
import com.dicoding.localdataapplication.sqlite.entity.Note
import com.dicoding.localdataapplication.sqlite.helper.MappingHelper
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        adapter = NoteAdapter(object : NoteAdapter.OnItemClickCallback {
            override fun onItemClicked(selectedNote: Note?, position: Int?) {
                val intent = Intent(this@SQLiteMainActivity, NoteAddUpdateActivity::class.java)
