package com.dicoding.localdataapplication.simplenotif
...
class SimpleNotifMainActivity : AppCompatActivity() {
    companion object {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_simple_notif_main)
    }
